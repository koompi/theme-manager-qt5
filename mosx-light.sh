...
lookandfeeltool -a org.koompi.theme.koompi-mosx-light --resetLayout
sleep 10
...
# Lock screen
kwriteconfig5 --file kscreenlockerrc --group Greeter --group Wallpaper --group org.kde.image --group General --key Image "file:///usr/share/wallpapers/abstract-purple-pink-digital-art-uhdpaper.com-4K-4.299.jpg"
